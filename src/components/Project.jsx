...
const Project = ({ index, title, setModal }) => {
  return (
    <div className="flex justify-between w-full items-center cursor-pointer border-t-[1px] border-[#c9c9c9] duration-200 last:border-b-[1px] last:border-[#c9c9c9] hover:opacity-50 group py-16">
